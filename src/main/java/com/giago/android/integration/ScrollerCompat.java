...
package com.giago.android.integration;
 ...
 *
 * <p> This class provides a platform version-independent mechanism for obeying the current device's preferred scroll
 * physics and fling behavior. It offers a subset of the APIs from Scroller or OverScroller. </p>
 */
class ScrollerCompat {
     ...
     *
     * TODO: Approximate a sane result for older platform versions. Right now this will return 0 for platforms earlier
     * than ICS. This is acceptable at the moment only since it is only used for EdgeEffect, which is also only present
     * in ICS+, and ScrollerCompat is not public.
     *
     ...
     *
     * @param startX   Starting horizontal scroll offset in pixels. Positive numbers will scroll the content to the
     *                 left.
     * @param startY   Starting vertical scroll offset in pixels. Positive numbers will scroll the content up.
     * @param dx       Horizontal distance to travel. Positive numbers will scroll the content to the left.
     * @param dy       Vertical distance to travel. Positive numbers will scroll the content up.
